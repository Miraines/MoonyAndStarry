...
const (
	...
	Auth_TelegramAuth_FullMethodName = "/auth.v1.Auth/TelegramAuth"
	Auth_Refresh_FullMethodName      = "/auth.v1.Auth/Refresh"
	Auth_Validate_FullMethodName     = "/auth.v1.Auth/Validate"
	Auth_Logout_FullMethodName       = "/auth.v1.Auth/Logout"
	Auth_HealthCheck_FullMethodName  = "/auth.v1.Auth/HealthCheck"
)
...
type AuthClient interface {
	...
	TelegramAuth(ctx context.Context, in *TelegramAuthRequest, opts ...grpc.CallOption) (*LoginResponse, error)
...
func (c *authClient) TelegramAuth(ctx context.Context, in *TelegramAuthRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, Auth_TelegramAuth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	TelegramAuth(context.Context, *TelegramAuthRequest) (*LoginResponse, error)
...
func (UnimplementedAuthServer) TelegramAuth(context.Context, *TelegramAuthRequest) (*LoginResponse, error) {
...
func _Auth_TelegramAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TelegramAuthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).TelegramAuth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_TelegramAuth_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).TelegramAuth(ctx, req.(*TelegramAuthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Auth_TelegramAuth_Handler,
		},
		{
			MethodName: "Refresh",
